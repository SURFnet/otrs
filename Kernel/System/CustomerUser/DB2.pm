...
sub CustomerUserDataGet {
    ...
    my %CustomerCompanyData = $CustomerCompany->CustomerCompanyGet(
        CustomerID => $Data{UserCustomerID},
    );
    delete($CustomerCompanyData{'Config'});
    delete($CustomerCompanyData{'Source'});
    %Data = (%Data, %CustomerCompanyData);
